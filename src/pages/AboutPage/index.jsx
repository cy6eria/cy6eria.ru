    ...
    render () {
        return (
            <article className="about-page">
                ...
                <h1>Привет!</h1>
                <p>Меня зовут Гундоров Евгений (<span lang="en">Eugene Gundorov</span>). Я также никому неизвестен как <strong>cy6eria</strong> (но я работаю над этим). Я живу в <city>Казани</city>, работаю front-end разработчиком и увлекаюсь программированием, робототехникой, фотографией, музыкой, а также люблю путишествовать.</p>
