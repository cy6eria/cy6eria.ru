...
export const data = {
  ...
  summary: 'Experienced Front-end Software Engineer with 10+ years in the industry. Proficient with React. Created web banking apps with big corporations and real-time data visualization tools in a startup way.',
  workHistory: [
        {
          ...
          responsibilities: `
* Collaboration with stakeholders as a part of a distributed, remote team;
* Working out ways to implement new features;
* Development front-end (mostly) and backend features, code review, unit testing;
* Write a technical documentation;
          `,
          achievements: `
* Launched a NFT marketplace based on Seaport protocol;
* Suggested and implemented a PWA as low cost alternative to a mobile app;
          `,
          technologies: ['React', 'Typescript', 'web3', 'Ethereum', 'Seaport', 'Redux', 'MUI', 'Webpack', 'Node.js', 'Agile'],
      },
      {
